...
class DashboardController extends Controller
{
    ...
    public function index(){
        ...
        $saldo = Keuangan::all()->last();
        $rekap = DB::table('keuangans')->whereNotIn('status',[!null])
        ->select(DB::raw('DATE_FORMAT(tanggal,"%M") as month'),
        ...
        // dd($bulan);
        return view('home', compact('data','now','donasi','pengeluaran','pemasukan','saldo','bulan','masuk','keluar'),[
            'title' => 'Dashboard'
        ]);
    }
}
